...
<p align="center">
  <b>A powerful, fast & customizable WhatsApp Multi‑Device bot built with Node.js</b>
</p>
...
- ✅ Group Management (Add, Kick, Promote, Demote)  
...
### 🔹 Local / VPS
```bash
git clone https://github.com/ADDICT-HUB/X-GURU.git
cd X-GURU
npm install
npm start
